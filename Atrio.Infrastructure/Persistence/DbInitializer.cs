...
public static class DbInitializer
{
    public static async Task InitializeAsync(IServiceProvider services, CancellationToken cancellationToken = default)
    {
        ...
        var teacher = new User { Id = Guid.NewGuid(), FullName = "Morgan Teacher", Email = "teacher@atrio.com", Role = UserRole.Teacher };
        ...
        var science = new Class { Id = Guid.NewGuid(), Name = "Computer Science 12A", Code = "CSC-12A", AcademicYear = "2026", IsActive = true };
